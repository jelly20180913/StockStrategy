	...
	public partial class FormUpdateStockIndex : Form
	{
		...
		private void btnUpdate_Click(object sender, EventArgs e)
		{
			...
			{ 
				...
				s.TX_High =this.txtHigh.Text;
				s.TX_Open = this.txtOpen.Text;
				s.TX_Low = this.txtLow.Text;
				s.C10YearBond_IndexQuotePercent = this.txtBondIndex.Text != "" ? this.txtBondIndex.Text : s.C10YearBond_IndexQuotePercent; 
