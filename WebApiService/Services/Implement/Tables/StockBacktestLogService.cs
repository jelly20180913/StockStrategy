...
namespace WebApiService.Services.Implement.Tables
{
	...
	{
		private IRepository<StockResult> _repository;

		public StockResultService(IRepository<StockResult> repository)
		{
			this._repository = repository;
		}
		public string Create(StockResult instance)
		{
			if (instance == null)
			{
		...
		public void Update(StockResult instance)
		{
			if (instance == null)
			{
				throw new ArgumentNullException();
		...
		public StockResult GetByID(int Id)
		{
			return this._repository.Get(x => x.Id == Id);
		}

		public IEnumerable<StockResult> GetAll()
		{
			return this._repository.GetAll();
		}
		public List<string> MiltiCreate(List<StockResult> instance)
		{
			List<string> _ListError = new List<string>();
			_ListError = this._repository.CreateBatch(instance);
			return _ListError;
		}
		public IEnumerable<StockResult> Filter(string sql)
		{
