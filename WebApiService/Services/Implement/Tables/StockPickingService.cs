...
namespace WebApiService.Services.Implement.Tables
{
	...
	{
		private IRepository<StockPicking> _repository;

		public StockPickingService(IRepository<StockPicking> repository)
		{
			this._repository = repository;
		}
		public string Create(StockPicking instance)
		{
			if (instance == null)
			{
		...
		public void Update(StockPicking instance)
		{
			if (instance == null)
			{
				throw new ArgumentNullException();
		...
		public StockPicking GetByID(int Id)
		{
			return this._repository.Get(x => x.Id == Id);
		}

		public IEnumerable<StockPicking> GetAll()
		{
			return this._repository.GetAll();
		}
		public List<string> MiltiCreate(List<StockPicking> instance)
		{
			List<string> _ListError = new List<string>();
			_ListError = this._repository.CreateBatch(instance);
			return _ListError;
		}
		public IEnumerable<StockPicking> Filter(string sql)
		{
